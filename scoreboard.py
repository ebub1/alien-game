...
class Scoreboard():
    ...
    def prep_level(self):
        """Preparing level and an image"""
        self.level_str = "Lvl:{}".format(self.stats.level)
        self.level_image = self.font.render(str(self.level_str), True, self.text_color, self.ai_settings.bg_colour)
